...
public class InstaBriefProperties {
    ...
    public void setNewsApiUrl(String newsApiUrl) { this.newsApiUrl = newsApiUrl; }
    public String getNewsApiCountry() { return newsApiCountry; }
    public void setNewsApiCountry(String newsApiCountry) { this.newsApiCountry = newsApiCountry; }
    public int getNewsApiPageSize() { return newsApiPageSize; }
    public void setNewsApiPageSize(int newsApiPageSize) { this.newsApiPageSize = newsApiPageSize; }
    public String getRssFeedUrls() { return rssFeedUrls; }
    public void setRssFeedUrls(String rssFeedUrls) { this.rssFeedUrls = rssFeedUrls; }
    public String getHfApiToken() { return hfApiToken; }
    public void setHfApiToken(String hfApiToken) { this.hfApiToken = hfApiToken; }
    public String getHfSummaryModel() { return hfSummaryModel; }
    public void setHfSummaryModel(String hfSummaryModel) { this.hfSummaryModel = hfSummaryModel; }
    public String getHfApiUrl() { return hfApiUrl; }
    public void setHfApiUrl(String hfApiUrl) { this.hfApiUrl = hfApiUrl; }
    public boolean isIngestionEnabled() { return ingestionEnabled; }
    public void setIngestionEnabled(boolean ingestionEnabled) { this.ingestionEnabled = ingestionEnabled; }
    public long getIngestionFixedDelayMs() { return ingestionFixedDelayMs; }
    public void setIngestionFixedDelayMs(long ingestionFixedDelayMs) { this.ingestionFixedDelayMs = ingestionFixedDelayMs; }
    public long getTrendingFixedDelayMs() { return trendingFixedDelayMs; }
    public void setTrendingFixedDelayMs(long trendingFixedDelayMs) { this.trendingFixedDelayMs = trendingFixedDelayMs; }
